...
require_once dirname(__FILE__).'/../lib/activeListingGeneratorConfiguration.class.php';
require_once dirname(__FILE__).'/../lib/activeListingGeneratorHelper.class.php';

/**
 * activeListing actions.
 *
 * @package    intranet
 ...
 */
class activeListingActions extends autoActiveListingActions
{

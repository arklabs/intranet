...
require_once dirname(__FILE__).'/../lib/clientAssetsGeneratorConfiguration.class.php';
require_once dirname(__FILE__).'/../lib/clientAssetsGeneratorHelper.class.php';

/**
 * clientAssets actions.
 *
 * @package    intranet
 * @subpackage clientAssets
 * @author     Your name here
 * @version    SVN: $Id: actions.class.php 12474 2008-10-31 10:41:27Z fabien $
 */
class clientAssetsActions extends autoClientAssetsActions
{

...
require_once dirname(__FILE__).'/../lib/conditionsSentGeneratorConfiguration.class.php';
require_once dirname(__FILE__).'/../lib/conditionsSentGeneratorHelper.class.php';

/**
 * conditionsSent actions.
 *
 * @package    intranet
 ...
 */
class conditionsSentActions extends autoConditionsSentActions
{

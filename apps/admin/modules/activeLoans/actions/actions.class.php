...
require_once dirname(__FILE__).'/../lib/activeLoansGeneratorConfiguration.class.php';
require_once dirname(__FILE__).'/../lib/activeLoansGeneratorHelper.class.php';
 ...
 */
class activeLoansActions extends autoActiveLoansActions
{

...
require_once dirname(__FILE__).'/../lib/incommingCallProspectGeneratorConfiguration.class.php';
require_once dirname(__FILE__).'/../lib/incommingCallProspectGeneratorHelper.class.php';

/**
 * incommingCallProspect actions.
 *
 * @package    intranet
 ...
 */
class incommingCallProspectActions extends autoIncommingCallProspectActions
{

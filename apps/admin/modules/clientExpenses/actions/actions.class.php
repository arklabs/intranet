...
require_once dirname(__FILE__).'/../lib/clientExpensesGeneratorConfiguration.class.php';
require_once dirname(__FILE__).'/../lib/clientExpensesGeneratorHelper.class.php';

/**
 * clientExpenses actions.
 *
 * @package    intranet
 * @subpackage clientExpenses
 * @author     Your name here
 * @version    SVN: $Id: actions.class.php 12474 2008-10-31 10:41:27Z fabien $
 */
class clientExpensesActions extends autoClientExpensesActions
{

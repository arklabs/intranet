...
require_once dirname(__FILE__).'/../lib/incommingCallReasonGeneratorConfiguration.class.php';
require_once dirname(__FILE__).'/../lib/incommingCallReasonGeneratorHelper.class.php';

/**
 * incommingCallReason actions.
 *
 * @package    intranet
 * @subpackage incommingCallReason
 * @author     Your name here
 * @version    SVN: $Id: actions.class.php 12474 2008-10-31 10:41:27Z fabien $
 */
class incommingCallReasonActions extends autoIncommingCallReasonActions
{

...
require_once dirname(__FILE__).'/../lib/assessorGeneratorConfiguration.class.php';
require_once dirname(__FILE__).'/../lib/assessorGeneratorHelper.class.php';
 ...
 */
class assessorActions extends autoAssessorActions
{

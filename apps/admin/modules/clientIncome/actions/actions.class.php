...
require_once dirname(__FILE__).'/../lib/clientIncomeGeneratorConfiguration.class.php';
require_once dirname(__FILE__).'/../lib/clientIncomeGeneratorHelper.class.php';

/**
 * clientIncome actions.
 *
 * @package    intranet
 ...
 */
class clientIncomeActions extends autoClientIncomeActions
{

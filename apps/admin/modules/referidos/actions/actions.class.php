...
require_once dirname(__FILE__).'/../lib/referidosGeneratorConfiguration.class.php';
require_once dirname(__FILE__).'/../lib/referidosGeneratorHelper.class.php';
 ...
 */
class referidosActions extends autoReferidosActions
{

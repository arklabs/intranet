...
require_once dirname(__FILE__).'/../lib/incommingCallRealStateGeneratorConfiguration.class.php';
require_once dirname(__FILE__).'/../lib/incommingCallRealStateGeneratorHelper.class.php';

/**
 * incommingCallRealState actions.
 *
 * @package    intranet
 ...
 */
class incommingCallRealStateActions extends autoIncommingCallRealStateActions
{

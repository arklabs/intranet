...
require_once dirname(__FILE__).'/../lib/externalAgentGeneratorConfiguration.class.php';
require_once dirname(__FILE__).'/../lib/externalAgentGeneratorHelper.class.php';

/**
 * externalAgent actions.
 *
 * @package    intranet
 ...
 */
class externalAgentActions extends autoExternalAgentActions
{

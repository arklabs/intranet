...
require_once dirname(__FILE__).'/../lib/houseGeneratorConfiguration.class.php';
require_once dirname(__FILE__).'/../lib/houseGeneratorHelper.class.php';
 ...
 */
class houseActions extends autoHouseActions
{

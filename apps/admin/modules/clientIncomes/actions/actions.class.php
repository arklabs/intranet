...
require_once dirname(__FILE__).'/../lib/clientIncomesGeneratorConfiguration.class.php';
require_once dirname(__FILE__).'/../lib/clientIncomesGeneratorHelper.class.php';

/**
 * clientIncomes actions.
 *
 * @package    intranet
 ...
 */
class clientIncomesActions extends autoClientIncomesActions
{

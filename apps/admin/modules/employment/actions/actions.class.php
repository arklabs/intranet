...
require_once dirname(__FILE__).'/../lib/employmentGeneratorConfiguration.class.php';
require_once dirname(__FILE__).'/../lib/employmentGeneratorHelper.class.php';
 ...
 */
class employmentActions extends autoEmploymentActions
{

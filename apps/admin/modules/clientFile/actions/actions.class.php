...
require_once dirname(__FILE__).'/../lib/clientFileGeneratorConfiguration.class.php';
require_once dirname(__FILE__).'/../lib/clientFileGeneratorHelper.class.php';
 ...
 */
class clientFileActions extends autoClientFileActions
{

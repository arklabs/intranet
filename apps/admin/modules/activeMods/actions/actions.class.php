...
require_once dirname(__FILE__).'/../lib/activeModsGeneratorConfiguration.class.php';
require_once dirname(__FILE__).'/../lib/activeModsGeneratorHelper.class.php';
 ...
 */
class activeModsActions extends autoActiveModsActions
{

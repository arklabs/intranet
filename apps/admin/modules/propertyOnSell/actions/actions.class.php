...
require_once dirname(__FILE__).'/../lib/propertyOnSellGeneratorConfiguration.class.php';
require_once dirname(__FILE__).'/../lib/propertyOnSellGeneratorHelper.class.php';

/**
 * propertyOnSell actions.
 *
 * @package    intranet
 ...
 */
class propertyOnSellActions extends autoPropertyOnSellActions
{

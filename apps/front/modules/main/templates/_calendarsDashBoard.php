...
echo _tag('h2.#dboard-toogle-trigger.fieldset_title.ui-helper-reset.collapsable-box-header style="text-align: left;width: 300px !important;"', '<span class="ui-icon ui-icon-triangle-1-e fieldset_icon"></span><span class="fieldset_name">Calendarios</span>');

...
use_stylesheet('/arkCompleteJQueryDateTimePickerPlugin/css/time-picker-ui-custom.css');
use_stylesheet('/arkCompleteJQueryDateTimePickerPlugin/css/timepicker.css');
use_javascript('/arkCompleteJQueryDateTimePickerPlugin/js/datepicker.js');
use_javascript('/arkCompleteJQueryDateTimePickerPlugin/js/jquery-timepicker.js');
...
echo _open('div',array('style'=>'width: 440px;'));
        ...
        $('#calendar-container').DatePicker({
         ...
         $('#load-dates-trigger').click(function(){
             ...
             $.ajax({
                     ...
                     error: function(){
                         alert('Ha ocurrido un error mientras se obten�a la lista de citas.');
                     }
                 });
         });
